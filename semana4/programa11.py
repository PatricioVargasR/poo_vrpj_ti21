"""
    ...
    Fecha: 09/02/2023
    Descripción: 8 formas distintas con función pythonic
"""

def mayor(numero1:int, numero2:int) -> int and None:  # Definimos una función con dos parametros especificando el tipo de dato y el tipo de dato de salida
