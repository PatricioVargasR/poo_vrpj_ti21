...
numero1 = float(
    input("Ingresa tu primer número: "))  # Se pide un valor desde el teclado
numero2 = float(
    input("Ingresa tu segundo número: "))  # Se pide un valor desde el teclado


def maximo_comun_divisor(
        numero1, numero2):  # Se crea una función que toma dos parametros
...
def minimo_comun_multiplo(numero1,
                          numero2):  # Se crea una función con dos parametros
    return (numero1 * numero2) / maximo_comun_divisor(
        numero1,
        numero2)  # Retorna el valor de numero1*numero2 entre la función mcd


mcm = minimo_comun_multiplo(
    numero1, numero2)  # Se asigna el valor de mcm con los parametros de mcm
print(f"El mínimo común múltiplo de {numero1} y {numero2} es {mcm}"
      )  # Se imprime el valor de mcm
